...
Route::middleware("auth:sanctum")->post("/tokens/create", function (
    ...
    $token = $request
        ->user()
        ->createToken($request->input("token_name", "api"));
...
Route::middleware(["auth:sanctum"])->group(function () {
    ...
    Route::post("/job-listings", [
        JobListingController::class,
        "store",
    ])->middleware(AllowTo::class . ":employer");
    Route::put("/job-listings/{job_listing}", [
        JobListingController::class,
        "update",
    ])->middleware(AllowTo::class . ":employer");
    Route::delete("/job-listings/{job_listing}", [
        JobListingController::class,
        "destroy",
    ])->middleware(AllowTo::class . ":employer");
});
...
Route::middleware(["auth:sanctum", AllowTo::class . ":admin"])->group(
    function () {
        Route::get("/admin/employers", [
            AdminController::class,
            "reviewEmployerProfiles",
        ]);
        Route::get("/admin/job-listings", [
            AdminController::class,
            "reviewJobListings",
        ]);
        Route::get("/admin/employers/{employerId}", [
            AdminController::class,
            "reviewEmployerProfile",
        ]);
        Route::get("/admin/job-listings/{jobListingId}", [
            AdminController::class,
            "reviewJobListing",
        ]);
        Route::put("/admin/job-listings/{jobListingId}/status", [
            AdminController::class,
...
Route::middleware(["auth:sanctum"])->group(function () {
    ...
    Route::put("/candidates/", [
        EmployerCandidateController::class,
        "update",
    ])->middleware(AllowTo::class . ":candidate");
    Route::put("/candidates/upload/resumes", [
        UploadController::class,
        "uploadResume",
    ]);
});
